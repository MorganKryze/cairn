...
| `icon`       | no       | neutral glyph | Slug, URL or `/assets` path, or `{light, dark}` for a [monochrome mark](../configuration/theming.md#artwork-that-cannot-serve-both-themes); see [Icons](../recipes/icons.md). |
