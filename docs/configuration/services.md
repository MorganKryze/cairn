...
| ---------- | -------- | ------------- | ----------------------------------------- |
| `id`       | yes      | —             | Unique slug; becomes the detail page URL. Lowercase letters, digits, dashes. |
| `url`      | yes      | —             | Where the card links. `https://…` or an absolute path. |
| `name`     | yes      | —             | The card title.                           |
