...
| `url`        | yes\*    | n/a           | `http(s)://…` or absolute path; optional with `state: soon` or `state: retired`                                                                                                                                                                  |
...
| `search`                | `true`      | `false` removes the header search box, its script and its `Cmd+K` shortcut                                                                                                                                                |
