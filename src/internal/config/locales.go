...
var builtinStrings = map[string]map[string]string{
	...
	"fr": {
		...
		"state.new":          "Nouveau",
		"signin.label":       "Connexion requise",
	...
	"de": {
		...
		"state.new":          "Neu",
		"signin.label":       "Anmeldung erforderlich",
	...
	"es": {
		...
		"state.new":          "Nuevo",
		"signin.label":       "Requiere iniciar sesión",
	...
	"it": {
		...
		"state.deprecated":   "Obsoleto",
		"state.new":          "Nuovo",
		"signin.label":       "Accesso richiesto",
	...
	"pt": {
		...
		"state.deprecated":   "Obsoleto",
		"state.new":          "Novo",
		"signin.label":       "Requer início de sessão",
