...
var builtinStrings = map[string]map[string]string{
	"en": {
		...
		"state.retired":      "No longer available",
		"state.beta":         "Beta",
	...
	"fr": {
		...
		"leave.copied":       "Copiée",
		"state.soon":         "Bientôt disponible",
		"state.retired":      "Plus disponible",
		"state.beta":         "Bêta",
		"state.deprecated":   "Obsolète",
		"state.new":          "Nouveau",
		"leave.go":           "Continuer",
	...
	"de": {
		...
		"state.soon":         "Demnächst",
		"state.retired":      "Nicht mehr verfügbar",
		"state.beta":         "Beta",
		"state.deprecated":   "Veraltet",
		"state.new":          "Neu",
		"leave.go":           "Fortfahren",
	...
	"es": {
		...
		"state.soon":         "Próximamente",
		"state.retired":      "Ya no disponible",
		"state.beta":         "Beta",
		"state.deprecated":   "Obsoleto",
		"state.new":          "Nuevo",
		"leave.go":           "Continuar",
	...
	"it": {
		...
		"state.soon":         "Prossimamente",
		"state.retired":      "Non più disponibile",
		"state.beta":         "Beta",
		"state.deprecated":   "Obsoleto",
		"state.new":          "Nuovo",
		"leave.go":           "Continua",
	...
	"nl": {
		...
		"state.soon":         "Binnenkort",
		"state.retired":      "Niet meer beschikbaar",
		"state.beta":         "Bèta",
		"state.deprecated":   "Verouderd",
		"state.new":          "Nieuw",
		"leave.go":           "Doorgaan",
	...
	"pt": {
		...
		"state.soon":         "Em breve",
		"state.retired":      "Já não disponível",
		"state.beta":         "Beta",
		"state.deprecated":   "Obsoleto",
		"state.new":          "Novo",
		"leave.go":           "Continuar",
	...
	"sv": {
		...
		"nav.links":          "Länkar",
		"nav.theme":          "Tema",
		"about.dismiss":      "Avvisa",
		"foot.powered":       "driven av",
		"search.label":       "Sök",
		"search.placeholder": "Sök verktyg",
		"search.empty":       "Inga resultat. Försök med ett annat ord.",
		"search.one":         "1 resultat",
		"search.many":        "%d resultat",
		"cat.other":          "Annat",
		"card.more":          "Läs mer",
		"detail.open":        "Öppna",
		...
		"status.maintenance": "Underhåll",
		"status.unknown":     "Okänd",
		"status.link":        "visa status",
		"host.self":          "Självhostad",
		"nav.menu":           "Meny",
		"nav.top":            "Tillbaka till toppen",
		"host.external":      "Extern",
		"leave.title":        "Du lämnar denna katalog",
		"leave.body":         "Denna adress tillhör någon annan. Läs den innan du går.",
		"leave.copy":         "Kopiera adressen",
		"leave.copied":       "Kopierad",
		"state.soon":         "Kommer snart",
		"state.retired":      "Inte längre tillgänglig",
		"state.beta":         "Beta",
		"state.deprecated":   "Föråldrad",
		"state.new":          "Ny",
		"leave.go":           "Fortsätt",
